...
curse_words_space = [
    ...
    "memek ", "kntl ", "idiot ", "bgst ", "goblok ", "noob ", "tolol ",
    "meki ", "jnck ", "kimak ", "qmak ", "fuck ", "n00b ", "jancok ", "cog ",
    "kuntul ", "kontol ", "bangsat ", "asu ", "bangsad ", "ngentot ", "fk "
]
...
curse_words = [
    ...
    "kntl", "idiot", "bgst", "goblok", "noob", "tolol", "meki", "jnck",
    "kimak", "qmak", "fuck", "n00b", "jancok", "cog", "kuntul", "kontol",
    "bangsat", "asu", "bangsad", "ngentot", "fk"
]
...
starter_encouragement = [
    "Don't give up!", "Use your ultra heart to believe!",
...
async def on_message(message):
    ...
    if db["responding"]:
        ...
        if msg.startswith('$ul'):
            ...
            await message.channel.send(file=discord.File("Ultraman_Card/" +
                                                         pathul))
        if ':v' in msg.lower():
        ...
        if 'petra' in msg.lower() or 'ukp' in msg.lower(
        ) or 'pcu' in msg.lower():
        ...
        if 'tatakae' in msg.lower():
            if str(message.author) == "darrellcr#2600":
                ...
                await message.channel.send(
                    file=discord.File("brimstonekenny.jpg"))
            else:
        ...
        if 'cok' in msg.lower() and not message.author.bot:
            ...
            if cok % 100 == 0:
                await message.channel.send("Congrats we surpassed " +
                                           str(cok) + " cok @everyone")
                if cok > 500:
                    await message.channel.send(
                        "Coming soon for 1000th special cok")
            file.close()
